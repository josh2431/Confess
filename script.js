...
function increaseMeter(amount) {
    ...
    // Special messages at certain levels
    if (affection >= 50 && affection - amount < 50) {
        showMessage("You're halfway to my heart! 💝");
    }
    if (affection >= 80 && affection - amount < 80) {
        showMessage("You have most of my heart already! 💖");
    }
    if (affection === 100) {
        showMessage("You have all of my heart! 💕", 5000);
    }
}
...
const messages = {
    'interactive-cat': { msg: "You found Orenji — so playful and bright!", amount: 25 },
    'interactive-f1': { msg: "Full throttle! Let's go fast together!", amount: 25 },
    'interactive-fish': { msg: "Gliding like a betta fish — calm and lovely.", amount: 20 },
    'interactive-hamster': { msg: "Tiny and warm — just like this hamster.", amount: 20 },
    'interactive-flowers': { msg: "Flowers for you — I love you.", amount: 20 }
};
